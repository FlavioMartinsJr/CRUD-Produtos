...
public class SimpleButtonBar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose = new Componentes.Buttont();
        cmdResize = new Componentes.Buttont();
        cmdMinimize = new Componentes.Buttont();
    ...
    private Componentes.Buttont cmdClose;
    private Componentes.Buttont cmdMinimize;
    private Componentes.Buttont cmdResize;
